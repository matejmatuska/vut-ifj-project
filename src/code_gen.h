...
void generate_func_param_assign(char* param_id, size_t level, size_t UID, int param_index); // generates declaration and init of the parameters of the function
...
void generate_after_call_var_assign(int index, sym_tab_datatype from_type, char* var_id, size_t level, size_t UID, sym_tab_datatype to_type); //generates the assign of the retval 
//
...
void generate_push(token_t* token, size_t level, size_t UID);//generates push of the value on the stack
void generate_pop(char* var_id, size_t level, size_t UID); //generates pop of the value from the stack
void generate_declare_variable(char* var_id, size_t level, size_t UID); //generates declaration of the variable
void generate_init_variable(char* var_id, size_t level, size_t UID, sym_tab_datatype type);//generates init of the variable with default values
