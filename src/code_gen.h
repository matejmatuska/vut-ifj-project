...
void generate_param_before_call(int index, token_t* param); //generates the passing of the parameters before call
...
void generate_init_variable(char* var_id, sym_tab_datatype type);//generates init of the variable
